...
if regions == True:
    ax1.plot(
        x_Italy, y_Italy, transform=rotated_pole, color="k", zorder=4, linewidth=0.8
    )
    ax1.plot(
        x_Spain, y_Spain, transform=rotated_pole, color="k", zorder=4, linewidth=0.8
    )
    ax1.plot(
        x_France, y_France, transform=rotated_pole, color="k", zorder=4, linewidth=0.8
    )
ax1.set_title(" ")
