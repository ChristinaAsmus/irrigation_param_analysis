...
ws_irri_prescribed = (
    dsirr_prescribed["WSECHIRR"][:, x, y] / dsirr_prescribed["WSMXIRR"][:, x, y]
).to_series()
ws_irri_flextime = (
    dsirr_flextime["WSECHIRR"][:, x, y] / dsirr_flextime["WSMXIRR"][:, x, y]
).to_series()
ws_irri_adapt = (
    dsirr_adapt["WSECHIRR"][:, x, y] / dsirr_adapt["WSMXIRR"][:, x, y]
).to_series()
